...
class WebFoodTabScreen extends StatefulWidget {
  ...
  @override
  State<WebFoodTabScreen> createState() => _WebFoodTabScreenState();
}

class _WebFoodTabScreenState extends State<WebFoodTabScreen> {
